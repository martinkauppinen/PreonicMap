...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAME] = LAYOUT_preonic_grid( \
            ...
            KC_LCTL, KC_NO,   QWERTY, KC_LALT,   KC_SPC,  LOWER,  LOWER,   RAISE, NO_MINS, KC_LEFT,    KC_DOWN, KC_RGHT  \
            ),
    ...
    [_LOWER] = LAYOUT_preonic_grid(
            ...
            _______, LSFT(KC_1), NO_QUO2, LSFT(KC_3), NO_DLR, LSFT(KC_5), NO_AMPR, KC_P4, KC_P5, KC_P6, KC_PAST, NO_QUES, \
            _______, NO_SLSH, NO_LPRN, NO_RPRN, NO_EQL, NO_LESS, NO_GRTR, KC_P1, KC_P2, KC_P3, KC_PPLS, NO_APOS, \
            _______, NO_PIPE, NO_TILD, NO_ACUT, NO_BSLS, NO_CIRC, NO_PLUS, KC_P0, KC_PDOT, KC_PENT, KC_PMNS, _______, \
    ...
    [_RAISE] = LAYOUT_preonic_grid(
            _______, _______,   NO_AT,  NO_PND,  NO_DLR, _______, _______, NO_LCBR, NO_LBRC, NO_RBRC, NO_RCBR, NO_BSLS, \
            _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4, _______, _______, NO_LCBR, NO_LBRC, NO_RBRC, NO_RCBR, NO_QUOT, \
            _______,   KC_F5,   KC_F6,   KC_F7,   KC_F8, _______, NO_AT, NO_LPRN, NO_RPRN, NO_HALF, _______, _______, \
